...
utd.__assertEquals( firstObj.name, 'Jim Jimmy0', "findOne did not return the first object");
...
var jim4query = { name : 'Jim Jimmy4'};
var jim4 = db.testsync.findOne( jim4query );
//console.dir(jim4);
utd.__assertEquals( jim4.name, 'Jim Jimmy4', 'query='+util.inspect(jim4query)+' fail. '+util.inspect(jim4));
...
db.testsync.ensureIndex( { "name" : 1 } );
